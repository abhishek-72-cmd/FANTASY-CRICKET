...
/* ─── Fixture Card ─── */
const FixtureCard = ({ fixture, onViewSquad, onCreateContest, onViewContest }) => {
  ...
  return (
    <div className="am-fixture-card">
      ...
      <div className="am-card-actions">
        ...
        <button className="am-action-btn am-btn-create" onClick={() => onCreateContest(fixture)}>
          <Icon.Trophy /> Create
        </button>
  ...
  toggleAutomation={toggleAutomation}
      ...
      <div className="am-page">
        ...
        <div className="am-page-header">
          <div>
            <div className="am-page-title">Active contests <span>Matches</span></div>
